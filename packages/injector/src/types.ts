...
export interface ImmutableContainer {
     ...
     * @param bindToInstance (optional) If set to true the newly created instance
...
export interface Container extends ImmutableContainer {
    ...
    /**
     * Binds a factory that should only be resolved once. Subsequent calls into the container
     * will return the initial value generated by the given factory.
     *
     * ### Example
     *
     * In the following example the factory is only called once, even though the binding
     * is resolved twice:
     *
     * ```typescript
